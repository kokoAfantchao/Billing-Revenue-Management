...
more_cpt = [
              ...
              {:cpt_code => '0023T', :cpt_description => 'Phenotype drug test, hiv 1', :price =>100},
              ...
              {:cpt_code => '0028T', :cpt_description => 'Dexa body composition study', :price =>100},
              {:cpt_code => '0029T', :cpt_description => 'Magnetic tx for incontinence', :price =>100},
              {:cpt_code => '0030T', :cpt_description => 'Antiprothrombin antibody', :price =>100},
              {:cpt_code => '0031T', :cpt_description => 'Speculoscopy', :price =>100},
              {:cpt_code => '0032T', :cpt_description => 'Speculoscopy w/direct sample', :price =>100},
              {:cpt_code => '0033T', :cpt_description => 'Endovasc taa repr incl subcl', :price =>100},
              {:cpt_code => '0034T', :cpt_description => 'Endovasc taa repr w/o subcl', :price =>100},
              {:cpt_code => '0035T', :cpt_description => 'Insert endovasc prosth, taa', :price =>100},
              {:cpt_code => '0036T', :cpt_description => 'Endovasc prosth, taa, add-on', :price =>100},
              {:cpt_code => '0037T', :cpt_description => 'Artery transpose/endovas taa', :price =>100},
              {:cpt_code => '0038T', :cpt_description => 'Rad endovasc taa rpr w/cover', :price =>100},
              {:cpt_code => '0039T', :cpt_description => 'Rad s/i, endovasc taa repair', :price =>100},
              {:cpt_code => '0040T', :cpt_description => 'Rad s/i, endovasc taa prosth', :price =>100},
              {:cpt_code => '0041T', :cpt_description => 'Detect ur infect agnt w/cpas', :price =>100},
              {:cpt_code => '0042T', :cpt_description => 'Ct perfusion w/contrast, cbf', :price =>100},
              ...
              {:cpt_code => '0049T', :cpt_description => 'External circulation assist', :price =>100},
              {:cpt_code => '0050T', :cpt_description => 'Removal circulation assist', :price =>100},
              {:cpt_code => '0051T', :cpt_description => 'Implant total heart system', :price =>100},
              {:cpt_code => '0052T', :cpt_description => 'Replace component heart syst', :price =>100},
              {:cpt_code => '0053T', :cpt_description => 'Replace component heart syst', :price =>100},
              {:cpt_code => '0054T', :cpt_description => 'Bone surgery using computer', :price =>100}
            ]

# create rows in cpts table
